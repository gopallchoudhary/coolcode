...
export const metadata = {
	title: {
		absolute: "coolcode — the terminal AI coding agent",
	},
	description:
				...
				<div className={styles.navInner}>
					...
					>
						<pre className={styles.navWordmark} aria-hidden="true">
							<span className={styles.navWordmarkCool}>
								{TINY_WORDMARK.cool[0]}
							</span>{" "}
							<span className={styles.navWordmarkCode}>
								{TINY_WORDMARK.code[0]}
							</span>
							{"\n"}
							<span className={styles.navWordmarkCool}>
								{TINY_WORDMARK.cool[1]}
							</span>{" "}
							<span className={styles.navWordmarkCode}>
								{TINY_WORDMARK.code[1]}
							</span>
						</pre>
					</Link>
			...
			<main className={styles.main}>
				<section className={styles.hero}>
					<div className={styles.frame}>
						<p className={styles.badge}>CLI Agent</p>
						<h1 className={styles.headline}>
							The powerful AI coding agent that lives in your terminal.
						</h1>
						<p className={styles.sub}>
							coolcode streams a coding agent into a native terminal UI. It
							plans before it builds, executes tools inside your repository, and
					...
					<div className={styles.frame}>
						<div className={styles.tui}>
							<pre className={styles.tuiWordmark} aria-hidden="true">
								<span className={styles.tuiWordmarkCool}>
									{TINY_WORDMARK.cool[0]}
								</span>{" "}
								<span className={styles.tuiWordmarkCode}>
									{TINY_WORDMARK.code[0]}
								</span>
								{"\n"}
								<span className={styles.tuiWordmarkCool}>
