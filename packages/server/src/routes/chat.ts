...
type CoolcodeUIMessage = UIMessage<ChatMessageMetadata, never, InferUITools<ToolContracts>>;

const submitSchema = z.object({
    id: z.string(),
    messages: z
        .array(
            z.custom<CoolcodeUIMessage>((value) => {
...
function hasPendingToolCalls(message: CoolcodeUIMessage) {
    ...
    .post(
        ...
        async (c) => {
            ...
            const previousMessages = Array.isArray(session.messages)
                ? (session.messages as unknown as CoolcodeUIMessage[])
                : [];
            ...
            const nextMessages = await validateUIMessages<CoolcodeUIMessage>({
            ...
            return result.toUIMessageStreamResponse<CoolcodeUIMessage>({
